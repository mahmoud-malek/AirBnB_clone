#!/usr/bin/python3
"""Defines   my testing toconsole.py.
...
class TestHBNBCommand_update(unittest.TestCase):
    """  my testing totesting update from the  ."""
...
class TestHBNBCommand_count(unittest.TestCase):
    """  my testing totesting count method of HBNB comand interpreter."""
...
class TestHBNBCommand_prompting(unittest.TestCase):
    """  my testing totesting prompting of the  ."""
